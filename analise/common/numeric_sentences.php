...
//получаем ключевые слова и их численные характеристики
$keySentences = isset($_POST['sentences']) ? $_POST['sentences'] : false;
$keySentencesNumeric = isset($_POST['numeric']) ? $_POST['numeric'] : false;

$keySentences = explode("|",$keySentences);
$keySentencesNumeric = explode("|",$keySentencesNumeric);
...
require_once($CFG->dirroot .'/analise/common/include/numeric_sentences.inc.php');
print_footer();

...
//делим область на такое кол-во, чтобы не получить дробных чисел
$flag = false;
$i = 0;
while( $flag !== true )
{
...
// иначе Увеличим максимальное значение на 10% (для того, чтобы столбик
...
for ($i=0;$i<$count;$i++) 
{
    ...
    //первую линию из нуля не строим
   if ($i !== 0)  
    {
        //последняя точка - линию дальше не строим
...
$font_file = 'arial.ttf';
$imagetext1 = toUnicodeEntities("р а н г");
$imagetext2 = toUnicodeEntities("ч а с т о т а");

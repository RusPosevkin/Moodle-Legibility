...
$keyWords = isset($_POST['words']) ? $_POST['words'] : false;
$keyWordsNumeric = isset($_POST['numeric']) ? $_POST['numeric'] : false;

$keyWords = explode("|",$keyWords);
$keyWordsNumeric = explode("|",$keyWordsNumeric);
...
require_once($CFG->dirroot .'/analise/common/include/numeric_words.inc.php');
print_footer();
